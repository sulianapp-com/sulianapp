...
return [
    ...
    */
    ...
    |
    */
    'content' => \app\common\helpers\Serializer::serialize(function ($code, $minutes, $input) {
    ...
    */
    'data' => [
        'code' => \app\common\helpers\Serializer::serialize(function ($code) {
            return $code;
        }),
        'minutes' => \app\common\helpers\Serializer::serialize(function ($code, $minutes) {
            return $minutes;
        }),
    ],
