(function(window) {
                    ...
                    function(e, t) {
                        e.registerCommand(t, {
                            execCommand: function() {
                                ...
                                r.image_url('./index.php?c=utility&a=file&do=image&local=local&group_id=-999');
	...
	util.image = function(val, callback,options, base64options ) {
		...
		require(['jquery', 'fileUploader'], function($, fileUploader){
            ...
            fileUploader.image_url('./index.php?c=utility&a=file&do=image&local=local&group_id=-999');
        ...
        !i && o && (i = o),
            ...
            require(["fileUploader"],
                function(e) {
                    ...
                    e.image_url('./index.php?c=utility&a=file&do=image&local=local&group_id=-999');
