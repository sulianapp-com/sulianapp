        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 5px;">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li role="presentation" class="active" style="display: block;"><a aria-controls="link-app-system" role="tab" data-toggle="tab" href="#link-app-system" aria-expanded="true">系统页面</a></li>
                    <li role="presentation" style="display: block;"><a aria-controls="link-app-goods" role="tab" data-toggle="tab" href="#link-app-goods" aria-expanded="false">商品链接</a></li>
                    <li role="presentation" style="display: block;"><a aria-controls="link-app-cate" role="tab" data-toggle="tab" href="#link-app-cate" aria-expanded="false">商品分类</a></li>
                   {{--  {!! my_link_extra('nav') !!} --}}
                    <li role="presentation" style="display: block;"><a aria-controls="link-app-other" role="tab" data-toggle="tab" href="#link-app-other" aria-expanded="false">自定义链接</a></li>
                </ul>
            </div>
            <div class="modal-body tab-content">
                <div role="tabpanel" class="tab-pane link-app-system active" id="link-app-system">
                    <div class="mylink-con">
                        ...
                        <div id="fe-tab-link-li-11" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 11)" data-href="{{ yzAppUrl('home') }}">商城首页</div>
                        <div id="fe-tab-link-li-12" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 12)" data-href="{{ yzAppUrl('category') }}">分类导航</div>
                        ...
                        <div id="fe-tab-link-li-21" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 21)" data-href="{{ yzAppUrl('member') }}">会员中心</div>
                        <div id="fe-tab-link-li-22" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 22)" data-href="{{ yzAppUrl('member/orderList/0')}}">我的订单</div>
                        <div id="fe-tab-link-li-23" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 23)" data-href="{{ yzAppUrl('cart') }}">我的购物车</div>
                        <div id="fe-tab-link-li-24" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 24)" data-href="{{ yzAppUrl('member/collection') }}">我的收藏</div>
                        <div id="fe-tab-link-li-25" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 25)" data-href="{{ yzAppUrl('member/footprint') }}">我的足迹</div>
                        <div id="fe-tab-link-li-26" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 26)" data-href="{{ yzAppUrl('member/balance') }}">会员充值</div>
                        <div id="fe-tab-link-li-27" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 27)" data-href="{{ yzAppUrl('member/detailed') }}">余额明细</div>
                        <div id="fe-tab-link-li-28" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 28)" data-href="{{ yzAppUrl('member/balance') }}">余额提现</div>
                        <div id="fe-tab-link-li-29" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 29)" data-href="{{ yzAppUrl('member/address') }}">我的收货地址</div>
<!-- ======================================================================= -->
            <!-- 页面新增链接 -->
                        <div class="page-header">
                        ...
                        <div id="fe-tab-link-li-34" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 34)" data-href="{{ yzAppUrl('member/info') }}">会员信息</div>

                        <div id="fe-tab-link-li-35" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 35)" data-href="{{ yzAppUrl('member/editmobile') }}">修改手机</div>

                        <div id="fe-tab-link-li-36" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 36)" data-href="{{ yzAppUrl('member/balance') }}">余额</div>

                        <div id="fe-tab-link-li-37" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 37)" data-href="{{ yzAppUrl('member/detailed') }}">余额明细</div>

                        <div id="fe-tab-link-li-40" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 40)" data-href="{{ yzAppUrl('member/integral_v2') }}">积分</div>

                        <div id="fe-tab-link-li-41" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 41)" data-href="{{ yzAppUrl('member/income') }}">收入</div>

                        <div id="fe-tab-link-li-44" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 44)" data-href="{{ yzAppUrl('member/withdrawal') }}">收入提现</div>

                        <div id="fe-tab-link-li-45" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 45)" data-href="{{ yzAppUrl('member/incomedetails') }}">收入明细</div>

                        <div id="fe-tab-link-li-46" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 46)" data-href="{{ yzAppUrl('member/member_income_incomedetails_info') }}">收入明细详情</div>

                        <div id="fe-tab-link-li-48" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 48)" data-href="{{ yzAppUrl('member/presentationRecord') }}">提现记录</div>

                        <div id="fe-tab-link-li-50" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 50)" data-href="{{ yzAppUrl('member/address') }}">收货地址</div>

                        <div id="fe-tab-link-li-52" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 52)" data-href="{{ yzAppUrl('member/appendAddress') }}">添加收货地址</div>

                        <div id="fe-tab-link-li-53" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 53)" data-href="{{ yzAppUrl('extension/notPresent') }}">未提现分销佣金</div>

                        <div id="fe-tab-link-li-54" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 54)" data-href="{{ yzAppUrl('member/footprint') }}">我的足迹</div>

                        <div id="fe-tab-link-li-55" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 55)" data-href="{{ yzAppUrl('member/collection') }}">我的收藏</div>

                        <div id="fe-tab-link-li-56" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 56)" data-href="{{ yzAppUrl('member/myrelationship') }}">我的关系</div>

                        <div id="fe-tab-link-li-58" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 58)" data-href="{{ yzAppUrl('member/myEvaluation') }}">我的评价</div>

                        <div id="fe-tab-link-li-60" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 60)" data-href="{{ yzAppUrl('CommentDetails/2476/303/0') }}">评价详情</div>

                        <div id="fe-tab-link-li-61" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 61)" data-href="{{ yzAppUrl('member/extension') }}">我的推广</div>

                        <div id="fe-tab-link-li-62" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 62)" data-href="{{ yzAppUrl('extension/distribution') }}">分销商</div>

                        <div id="fe-tab-link-li-63" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 63)" data-href="{{ yzAppUrl('extension/commission') }}">预计佣金</div>

                        <div id="fe-tab-link-li-65" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 65)" data-href="{{ yzAppUrl('extension/unsettled') }}">未结算佣金</div>

                        <div id="fe-tab-link-li-67" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 67)" data-href="{{ yzAppUrl('extension/alreadySettled') }}">已结算佣金</div>

                        <div id="fe-tab-link-li-69" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 69)" data-href="{{ yzAppUrl('extension/notPresent') }}">未提现佣金</div>

                        <div id="fe-tab-link-li-71" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 71)" data-href="{{ yzAppUrl('extension/present') }}">已提现佣金</div>

                        <div id="fe-tab-link-li-73" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 73)" data-href="{{ yzAppUrl('extension/distributionOrder') }}">分销订单</div>

                        <div id="fe-tab-link-li-81" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 81)" data-href="{{ yzAppUrl('member/aftersaleslist') }}">售后列表</div>

                        <div id="fe-tab-link-li-84" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 84)" data-href="{{ yzAppUrl('coupon/coupon_index') }}">优惠券</div>

                        <div id="fe-tab-link-li-85" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 85)" data-href="{{ yzAppUrl('coupon/coupon_store') }}">领券中心</div>

                        <div id="fe-tab-link-li-89" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 89)" data-href="{{ yzAppUrl('search') }}">搜索</div>

                        <div id="fe-tab-link-li-90" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 90)" data-href="{{ yzAppUrl('login') }}">登录</div>

                        <div id="fe-tab-link-li-91" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 91)" data-href="{{ yzAppUrl('register') }}">注册</div>

                        <div id="fe-tab-link-li-92" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 92)" data-href="{{ yzAppUrl('category') }}">分类</div>

                        <div id="fe-tab-link-li-94" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 94)" data-href="{{ yzAppUrl('brand') }}">品牌</div>

                        <div id="fe-tab-link-li-96" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 96)" data-href="{{ yzAppUrl('cart') }}">购物车</div>

                        <div id="fe-tab-link-li-99" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 99)" data-href="{{ yzAppUrl('goodsorder') }}">填写订单</div>

                        <div id="fe-tab-link-li-101" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 101)" data-href="{{ yzAppUrl('voiceList') }}">音频文章</div>

                        <div id="fe-tab-link-li-101" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 101)" data-href="{{ yzAppUrl('/member/payrecharge') }}">支付积分</div>

                        <!-- 新增链接结束 -->
<!-- ========================================================================= -->
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane link-app-goods" id="link-app-goods">
                    <div class="input-group">
                        <input type="text" class="form-control" name="keyword" value="" id="select-app-good-kw" placeholder="请输入商品名称进行搜索 (多规格商品不支持一键下单)">
                        <span class="input-group-btn"><button type="button" class="btn btn-default" id="select-app-good-btn">搜索</button></span>
                    </div>
                    <div class="mylink-con" id="select-app-goods" style="height:266px;"></div>
                </div>
                ...
                <div role="tabpanel" class="tab-pane link-app-cate" id="link-app-cate">
                            ...
                            @foreach ($first_category as $goodcate_parent)
                                <div class="mylink-line">
                                    ...
                                    <div class="mylink-sub">
                                        <a href="javascript:;" id="category-{{ $goodcate_parent['id'] }}" class="mylink-app-nav" ng-click="chooseLink(1, 'category-{{ $goodcate_parent['id'] }}')" data-href="{{ yzAppUrl('catelist/:id') }}">选择</a>
                                    </div>
                                </div>
                                <?php
                                $sub_level = null;
                                ...
                                @if (!is_null($sub_level))
                                    @foreach ($sub_level as $goodcate_chlid)
                                        <div class="mylink-line">
                                            ...
                                            {{ $goodcate_chlid['name'] }}
                                            <div class="mylink-sub">
                                                <a href="javascript:;" class="mylink-app-nav" data-href="{{ yzAppUrl('catelist/' . $goodcate_chlid['id']) }}">选择</a>
                                            </div>
                                        </div>
                                        <?php
                                        $third_level = null;
                                            ...
                                            @foreach ($third_level as $goodcate_third)
                                                @if ($goodcate_third['parent_id'] == $goodcate_chlid['id'])
                                                    <div class="mylink-line">
                                                        ...
                                                        {{ $goodcate_third['name'] }}
                                                        <div class="mylink-sub">
                                                            <a href="javascript:;" class="mylink-app-nav" data-href="{{ yzAppUrl('catelist/' . $goodcate_third['id']) }}">选择</a>
                                                        </div>
                                                    </div>
                                                @endif
                                            @endforeach
                ...
                <div role="tabpanel" class="tab-pane link-app-cate" id="link-app-other">
                    <div class="mylink-con" style="height: 150px;">
                        ...
                        <div class="form-group" style="overflow: hidden; margin-bottom: 0px;">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <div class="btn btn-primary col-lg-1 mylink-app-nav2" id="other-1" ng-click="chooseLink(1, 'other-1')" style="margin-left: 20px; width: auto; overflow: hidden; margin-left: 0px;"> 插入 </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            success: function(data){
                ...
                if(data){
                    $.each(data,function(n,value){
                        ...
                        html+='<a href="javascript:;" class="mylink-app-nav" data-href="'+value.url+'">详情链接</a><br>';
